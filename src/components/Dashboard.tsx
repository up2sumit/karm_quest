        ...
        <div className="relative z-10 flex items-center justify-between">
          <div>
            ...
            <button
              ...
              className={`mt-4 px-5 py-2.5 rounded-xl text-[13px] font-semibold transition-all flex items-center gap-2 group ${isModern
          ...
          <div className={`${card} rounded-2xl p-5`}>
            ...
            <div className="flex gap-1 mt-3">
              {[...Array(7)].map((_, i) => (
                <div
                  key={i}
                  className={`flex-1 h-2 rounded-full transition-all ${i < (stats.streak % 7 || (stats.streak > 0 ? 7 : 0))
